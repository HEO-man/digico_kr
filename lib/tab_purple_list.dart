...
class TabPurpleList extends StatefulWidget {
  const TabPurpleList({Key? key}) : super(key: key);

  @override
  State<TabPurpleList> createState() => _TabPurpleListState();
}

class _TabPurpleListState extends State<TabPurpleList> {
  List<dynamic> items = [];
  bool isLoading = true;
  ...
  Future<void> fetchEquipment() async {
    try {
      final response = await http.get(Uri.parse('https://heo-man.github.io/digimon-codex-kr/data/equipment_json/purple_eq_list.json'));
